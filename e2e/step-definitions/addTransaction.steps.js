...
When(/^I add a income transaction with amount (.*) ,category (.*) ,payment mode (.*) and description (.*)$/, async (amount, category, mode, description) => {
...
When(/^I add a expense transaction with amount (.*) ,category (.*) ,payment mode (.*) and description (.*)$/, async (amount, category, mode, description) => {
